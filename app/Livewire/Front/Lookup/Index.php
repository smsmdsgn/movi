...
class Index extends Component
{
    ...
    public function render(): View
    {
        ...
        return view('front.lookup.lookup-form', [
            'selected' => $selected,
            'seats' => $selected === null ? collect() : $this->sortedSeats($selected),
            ...
            'isCancelled' => $selected?->status === ReservationStatus::Cancelled,
    ...
    /**
     * 座席表（P-31）・予約完了（P-38）と同じ並び順で示す。
     *
     * @return Collection<int, ReservationSeat>
     */
    private function sortedSeats(Reservation $reservation): Collection
    {
