...
it('予約フロー（7.1.1 P-36以降）のルートが画面IDを返し、クロール対象外となる（19.3-6 / 4.3.9）', function (string $routeName, string $screenId, array $parameters) {
    createCinema('gion', '祇園ムビ');
    ...
    'P-36 決済' => ['front.reservation.payment', 'P-36', ['id' => 1]],
]);
